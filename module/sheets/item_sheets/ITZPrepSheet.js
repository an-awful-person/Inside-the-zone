export default class ITZPrepSheet extends ItemSheet {

    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            template: `systems/inside-the-zone/templates/sheets/item sheets/prep-sheet.html`,
    ...
    activateListeners(html) {
        ...
        html.find(".requirements").change(e => {
            this.item.update({[ `system.requirements`]: e.target.value});
            this.render(false);
        })
    }
}